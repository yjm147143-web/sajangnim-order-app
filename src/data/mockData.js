...
(function () {
  ...
  function buildSeed() {
    ...
    const menuItems = [
      ...
      { id: 'menu-4', storeId: 'store-1', categoryId: 'cat-2', name: '레모네이드', price: 5000, description: '상큼한 생레몬 에이드', imageUrl: '', origin: '국내산 레몬', nutritionInfo: '', allergyInfo: '', stockQuantity: 25, autoSoldoutEnabled: false, soldOut: false, exposed: true, sortOrder: 1, promoType: 'FIRST_COME', optionGroups: [{ id: 'og-2', name: '얼음량', required: true, multiSelect: false, options: [{ name: '적게', price: 0 }, { name: '보통', price: 0 }, { name: '많이', price: 0 }] }] },
      { id: 'menu-5', storeId: 'store-1', categoryId: 'cat-3', name: '크로플', price: 6000, description: '바삭한 크로와상 와플', imageUrl: '', origin: '', nutritionInfo: '', allergyInfo: '밀, 대두 함유', stockQuantity: 15, autoSoldoutEnabled: true, soldOut: false, exposed: true, sortOrder: 1, promoType: 'HAPPY_HOUR', optionGroups: [] },
